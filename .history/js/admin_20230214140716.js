...
function getAllAccounts() {
  ...
  var arr = [];
  $.ajax({
    url: "http://192.168.1.60:8386/users/getAllAccounts",
    type: "GET",
    headers: {
...
function deleteAccount(id) {
  ...
  $.ajax({
    url: `http://192.168.1.60:8386/users/deleteAccount/${id}`,
    type: "DELETE",
    headers: {
      Authorization: `Bearer ${getCookie("token")}`,
    },
...
function updateAccount(id) {
  ...
  $.ajax({
    url: `http://192.168.1.60:8386/users/updateAccount`,
    type: "POST",
    headers: {
      Authorization: `Bearer ${getCookie("token")}`,
    },
...
function CreateAccount() {
  ...
  $.ajax({
    url: `http://192.168.1.60:8386/users/signUp`,
    headers: {
      Authorization: `Bearer ${getCookie("token")}`,
    },
    method: "POST",
